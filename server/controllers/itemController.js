...
exports.createItem = async (req, res) => {
    ...
    try {
        const [result] = await db.query(
            'INSERT INTO items (name, company, category, code, sales_rate, purchase_rate, gst_percent, unit) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
            [name, company || '', category, code, sales_rate, purchase_rate, gst_percent, unit]
        );
